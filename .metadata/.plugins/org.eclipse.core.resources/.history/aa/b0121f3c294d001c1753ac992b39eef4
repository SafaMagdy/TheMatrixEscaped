...
public class TestMatrixPublic {
	...
	public void testa0() throws Exception {
		...
		//it does not print the drop and I do not know why
	}
	*/
	...
	*/
	...
	public void testa3() throws Exception {
		...
		//different number of kills although 3 mutant hostages only but 5 kills appear in the test solution
	}
	*/
	...
	public void testa4() throws Exception {
		...
		//different number of kills although 2 mutant hostages only but 3 kills appear in the test solution
	...
	*/
	...
	public void testb0() throws Exception {
		...
		//String solution = "left,left,carry,left,carry,right,right,right,right,up,left,left,left,left,kill,down,right,right,right,right,up,left,left,left,up,drop,left,down,down,right,right,right,right,up,left,left,left,takePill,left,down,right,right,right,right,up,left,left,up,kill,left,left,down,down,right,right,right,right,up,left,left,takePill,left,left,down,right,right,right,right,up,left,up,left,left,left,up,kill,down,down,down,right,right,right,right,up,left,left,left,up;2;3;89";
		System.out.println(solution);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid0, solution));
		//passed
